...
def _public_required_paths() -> list[str]:
    required = [
        ...
        "src/release_manager.py", "src/release_manager_selftest.py", "src/startup_update.py", "src/workspace_migrator.py", "src/storage_lifecycle.py", "src/system_health.py", "src/project_quality_95.py", "src/autonomy_standard.py",
