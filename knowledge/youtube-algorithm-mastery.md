...
|---|---|---|---|---|
| **長片（5-10 min 教學）** | **6%+** | **50%+** AVP（2026 修正 ↑） | 60%+ | 35%+ |
| **長片（10+ min 教學）** | 6%+ | **45%+** AVP（2026 修正 ↑） | 60%+ | 30%+ |
| **長片（旅遊 Vlog）** | 5%+ | 35-45% AVP（niche 已塌方 -19%） | 55%+ | 25%+ |
| **Shorts** | n/a | 70%+ 不滑走 | n/a | 50%+ replay |

教學類算法 2026 基準：**45-55% retention 健康範圍**（[Hootsuite 2026](https://blog.hootsuite.com/youtube-algorithm/) — 比 Retention Rabbit 2025 的 42.1% 提高）— 軟體 / AI 工具教學目標 50%+。
...
### Exploration phase（發布頭 24-48h）

- 初始 ~1,000 impressions 給 subs + 相似興趣觀眾測試
- ~10% CTR 觸發 impression 指數放大
- 新片頭 24h 通常 2-10% CTR
- **頭 48h flop → 很難再起來**（除非遇到 trend reignite）
...
- 最佳窗口：**發布後 48-72h**（拿到初始 CTR 訊號後）
- 等 1-3 週看新 traffic 效果
- MrBeast 最多換 **10 次**；你 2-3 次合理（如果 48h CTR <4%）
- ⭐ 新片直接用 YT Test & Compare 跑 A/B
...
### 「Test fast, kill fast」[TRANSFERS]

- 追蹤頭 48h CTR + 頭 1-min retention
- 都 <baseline → 72h 內換 thumbnail/title
- 2 次換還沒救起來 → **放掉**，別再投時間
