...
- [youtube-algorithm-mastery.md](youtube-algorithm-mastery.md) — 深度 + MrBeast 戰術 + 留存工程
- [youtube-algorithm-2026.md](youtube-algorithm-2026.md) — 2026 演算法洞察（多軌創作者通用版）
...
- `viral-playbook-framework.md` — 爆款定義（機器點火/Expected Views/CTR×AVP 雙門檻）+ 六站命中率系統 + 對抗驗證方法論（v0.9）
