...
- M170：戰鬥陀螺「主體」與「設備」必須分開判斷。盜版／仿製陀螺可以玩、可以做正版 VS 盜版內容，前提是真偽標示誠實且不得靠外觀猜；社群高風險的是盜版戰鬥盤與盜版發射器，公開成片預設只使用／露出 Hao 已確認的正版戰鬥盤與發射器，設備真偽不明則停在 `BATTLE_GEAR_AUTHENTICITY_REQUIRED`。Hao 已刪除的未發布舊片不得被同步器復活；此撤回只針對那些成片，不等於全面禁止盜版陀螺題材。
